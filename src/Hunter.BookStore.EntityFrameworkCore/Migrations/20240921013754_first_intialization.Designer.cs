...
namespace Hunter.BookStore.Migrations
{
    ...
    [Migration("20240921013754_first_intialization")]
    partial class first_intialization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hunter.BookStore.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hunter.BookStore.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hunter.BookStore.Books.BookCategory", b =>
                {
            ...
            modelBuilder.Entity("Hunter.BookStore.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hunter.BookStore.Books.Book", b =>
                {
                    b.HasOne("Hunter.BookStore.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hunter.BookStore.Books.BookCategory", b =>
                {
                    b.HasOne("Hunter.BookStore.Books.Book", null)
                        .WithMany("Categories")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hunter.BookStore.Categories.Category", null)
                        .WithMany()
